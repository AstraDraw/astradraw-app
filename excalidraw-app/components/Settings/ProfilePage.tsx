...
export const ProfilePage: React.FC<ProfilePageProps> = ({ theme, setTheme }) => {
      ...
      <div className="profile-page__container">
        ...
        <section className="profile-page__row">
          <div className="profile-page__row-label">
            ...
            <p className="profile-page__shortcut-hint">⌥ + ⇧ + D</p>
          </div>
          <div className="profile-page__row-content">
            <div className="profile-page__theme-selector">
              <select
                className="profile-page__theme-dropdown"
                value={theme}
                onChange={(e) =>
              ...
              <span className="profile-page__theme-icon">
                {theme === THEME.DARK
                  ? moonIcon
                  : theme === THEME.LIGHT
                    ? sunIcon
