...
docker compose up -d
```
*Note: A hard refresh (Cmd+Shift+R) in the browser may be required to clear cached JavaScript.*

### GitHub Workflows
**Do I need to change workflows?**
**No**, you do not need to change the `.github/workflows/*.yml` files.
